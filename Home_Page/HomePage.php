  ...
  <body class="hold-transition sidebar-mini">
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="index3.html" class="brand-link" style="display: flex; align-items: center; justify-content: center;">
          <span class="brand-text font-weight-bold " style="font-size: larger;" >Reservo</span>
        </a>
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
              <a href="#" class="d-block">Mohammad Charaf</a>
            </div>
          </div>
      ...
      <div class="content-wrapper">
        ...
        <div class="content">
          ...
          <div class="row Calender_Container">
                ...
                <div class="card-body p-0" style=" display: flex; justify-content: center; align-items: center;">
                  ...
                  <div id="calendar" class="fc fc-media-screen fc-direction-ltr fc-theme-bootstrap">
                    <div class="fc-header-toolbar fc-toolbar fc-toolbar-ltr">
                        ...
                        <div class="fc-toolbar-chunk">
                            <h2 class="fc-toolbar-title" id="fc-dom-1">June 2025</h2>
                        </div>
                    ...
                    <!-- The rest of the calendar structure -->
                    <!-- Due to length, recommend using a templating engine or backend calendar render -->
                
                    <!-- For brevity, only essential structure reformatted -->
                
                    <div aria-labelledby="fc-dom-1" class="fc-view-harness fc-view-harness-active" style="height: 548.889px;">
                        <div class="fc-daygrid fc-dayGridMonth-view fc-view">
                            <table role="grid" class="fc-scrollgrid table-bordered fc-scrollgrid-liquid">
                                        ...
                                        <th role="presentation">
                                            <div class="fc-scroller-harness">
                                                <div class="fc-scroller" style="overflow: hidden;">
                                                    <table role="presentation" class="fc-col-header" style="width: 739px;">
                                                        <colgroup></colgroup>
                                ...
                                <!-- Table body and other details omitted for brevity -->
                            </table>
                        </div>
                    </div>
                </div>
                
                <!-- Note: Recommend programmatically generating the full calendar for production -->
                </div>                
                <!-- /.card-body -->
              </div>
              <!-- /.card -->
      ...
      <footer class="main-footer">
        <!-- To the right -->
        <div class="float-right d-none d-sm-inline">Welcome to our Reserving Web Application</div>
        <!-- Default to the left -->
        <strong
          >Copyright &copy; 2025 Reservo |
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
      ...
      // FullCalendar initialization example
      var calendar = new FullCalendar.Calendar(calendarEl, {
          initialView: 'dayGridMonth',
          events: [
              { title: 'All Day Event', start: '2025-06-01' },
              { title: 'Long Event', start: '2025-06-24', end: '2025-06-26' },
              { title: 'Meeting', start: '2025-06-29T10:30:00' },
              { title: 'Lunch', start: '2025-06-29T12:00:00' },
              { title: 'Birthday Party', start: '2025-06-30T19:00:00' }
          ]
      });
